...
![Maven Central](https://img.shields.io/maven-central/v/com.github.bgalek.utils/devicedetect?style=flat-square)
![Libraries.io dependency status for GitHub repo](https://img.shields.io/librariesio/github/bgalek/devicedetect.svg?style=flat-square)
...
```groovy
implementation "com.github.bgalek.utils:devicedetect:1.0.0"
```
